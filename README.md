...
基于Adaptive Knowledge-Grounded Learning[（AKGL）](https://github.com/zhaidewei/AKGL-engine)方法生成的一套Flink学习材料。
可以直接阅读或者使用 [AKGL](https://github.com/zhaidewei/AKGL-engine)提供的本地server阅读
